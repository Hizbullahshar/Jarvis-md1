...
module.exports = {
  ...
  AUDIO_DATA: process.env.AUDIO_DATA || 'Hᴇꜱᴏʏᴀᴍ;https://i.imgur.com/ep3UbBP.jpg',
  ...
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || 'Mᴀᴅᴇ Bʏ;Aʟᴀɴ Wᴀʟᴋᴇʀ',
  ...
  MEDIA_DATA: process.env.MEDIA_DATA|| 'Hᴇꜱᴏʏᴀᴍ;https://i.imgur.com/ltPPMTh.jpeg',
  SUDO: process.env.SUDO || '923278974102,3584573983953',
  HEROKU_APP_NAME: process.env.HEROKU_APP_NAME || '',
  HEROKU_API_KEY: process.env.HEROKU_API_KEY || '',
  BOT_INFO: process.env.BOT_INFO || 'Jᴀʀᴠɪꜱ;Hᴇꜱᴏʏᴀᴍ;https://i.imgur.com/VIpl3q5.mp4',
